                            ...
                            <tbody>
                                ...
                                while ($d = mysqli_fetch_object($sql)) {
                                    echo "<tr>
                                                ...
                                                <td>$d->faskes</td>
                                                <td>
                                                    <button class=\"btn btn-primary btn-sm btn-icon\"  onclick=\"edit('$d->id_pasien','pendaftaranfaskespasien')\"><i class=\"zmdi zmdi-edit\"></i></button>
                                                    <button class=\"btn btn-primary btn-sm btn-icon\"  onclick=\"hapus('$d->id_pasien','pendaftaranfaskespasien')\"><i class=\"zmdi zmdi-close-circle-o\"></i></button>
                                                </td>
                                            </tr>";
                                }
                                ?>
    ...
    <div class="modal fade" id="modal-form" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form id="form-submit" data-modul="pendaftaranfaskespasien">
